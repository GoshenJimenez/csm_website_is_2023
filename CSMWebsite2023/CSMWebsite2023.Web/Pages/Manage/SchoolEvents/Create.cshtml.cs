...
namespace CSMWebsite2023.Web.Pages.Manage.SchoolEvents
{
    public class Create : PageModel
    {
        ...
        public Create(ISchoolEventService schoolEventService, IWebHostEnvironment env)
        {
        ...
        public async Task OnPost()
        {
            if (ImageFile == null)
            {
                Error = "Please select an image file for your SchoolEvent";
                return;
            }
            ...
            {
                //$"//schoolEvent//{schoolEvent.Id}//article-image.png"
                var dirPath = _env.WebRootPath + "/schoolEvent/" + op.ReferenceId.ToString();
